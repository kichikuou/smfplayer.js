...
D.prototype.parse=function(){var b=this.input,a=this.a,d=this.t={},g=String.fromCharCode(b[a++],b[a++],b[a++],b[a++]);"melo"!==g&&n(Error("invalid MFi signature:"+g));d.Y=(b[a++]<<24|b[a++]<<16|b[a++]<<8|b[a++])>>>0;d.U=(b[a++]<<16|b[a++])+a;d.V=b[a++];d.W=b[a++];d.k=b[a++];this.a=a;for(var b=this.input,a=this.a,d=this.j={},c;a<this.t.U;)switch(g=String.fromCharCode(b[a++],b[a++],b[a++],b[a++]),c=b[a++]<<8|b[a++],g){case "titl":case "copy":case "vers":case "date":case "prot":d[g]=String.fromCharCode.apply(r,
b.subarray(a,a+=c));break;case "sorc":d[g]=b[a++];break;case "note":d[g]=b[a++]<<8|b[a++];break;default:d[g]=b.subarray(a,a+=c)}this.a=a;var b=this.input,a=this.a,e,h,f,d=this.i=[],j,g=0;for(c=this.t.k;g<c;++g){e=String.fromCharCode(b[a++],b[a++],b[a++],b[a++]);"trac"!==e&&n(Error("invalid track signature:"+e));e=b[a++]<<24|b[a++]<<16|b[a++]<<8|b[a++];e=a+e;for(j=d[g]=[];a<e;){f={};f.deltaTime=b[a++];h=b[a++];if(255!==h)f.type="note",f.subType="Note",f.voice=h>>6,f.key=h&63,f.length=b[a++],1===this.j.note&&
...
1]));l={data:b.subarray(a,a+=l-a)};h.value=l;break;default:n(Error("unkwnon message type:"+h.toString(16)))}break;default:n(Error("unkwnon message type:"+h.toString(16)))}j.push(f)}a=e}this.a=a};
...
J.prototype.parse=function(){var b=this.length+this.offset;for(this.n=[];this.a<b;){var a=this.input,d=this.a,g=p;this.n.push({type:String.fromCharCode(a[d++],a[d++],a[d++],a[d++]),size:g=this.G?(a[d++]<<24|a[d++]<<16|a[d++]<<8|a[d++])>>>0:(a[d++]|a[d++]<<8|a[d++]<<16|a[d++]<<24)>>>0,offset:d});d+=g;this.padding&&1===(d-this.offset&1)&&d++;this.a=d}};function K(b,a){var d=b.n[a];return d===p?r:d};function L(b,a){a=a||{};a.padding=s;a.bigEndian=!0;this.input=b;this.a=a.index||0;this.m=0;this.l=new J(b,a);this.i=[];this.A=[]}L.prototype.parse=function(){var b,a;this.l.parse();b=K(this.l,this.m++);a=this.input;var d=b.offset;(!b||"MThd"!==b.type)&&n(Error("invalid header signature"));this.I=a[d++]<<8|a[d++];this.k=a[d++]<<8|a[d++];this.T=a[d++]<<8|a[d++];b=0;for(a=this.k;b<a;++b)M(this)};
...
function O(b){b.stop();b.f=5E5;b.position=0;b.pause=s;b.g=r;b.e=-1;b.B=r;b.C=r;b.o=r;clearTimeout(b.d);b.h?P(b):window.addEventListener("message",function(a){"link,ready"===a.data&&P(b)},s)}u.play=function(){var b=this;this.b||n(Error("WebMidiLink not found"));this.h?(this.g instanceof Array&&this.position>=this.g.length&&(this.position=0),Q(this)):window.addEventListener("message",function(a){"link,ready"===a.data&&(b.h=!0,Q(b))},s)};
function P(b){b=b.b.contentWindow;var a;for(a=0;16>a;++a)b.postMessage("midi,b"+a.toString(16)+",07,64","*"),b.postMessage("midi,b"+a.toString(16)+",0a,40","*"),b.postMessage("midi,e"+a.toString(16)+",00,40","*"),b.postMessage("midi,b"+a.toString(16)+",64,00","*"),b.postMessage("midi,b"+a.toString(16)+",65,00","*"),b.postMessage("midi,b"+a.toString(16)+",06,02","*"),b.postMessage("midi,b"+a.toString(16)+",26,00","*")}
u.S=function(b){var a=this,d;this.b&&(document.body.removeChild(this.b),this.b=r);d=this.b=document.createElement("iframe");d.src=b||"http://www.g200kg.com/en/docs/gmplayer/";document.body.appendChild(d);window.addEventListener("message",function(b){"link,ready"===b.data&&(a.h=!0,a.D(a.v))},s)};u.D=function(b){var a;this.v=b;this.b&&(a=this.b.contentWindow,a.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(b&127).toString(16)).substr(-2),("0"+(b>>7&127).toString(16)).substr(-2),"7f"].join(),"*"))};u.R=t("F");
...
0};else if("END"===i[1]&&d.s){k=f[i[2]|0];if(0!==k.count){0<k.count&&k.count--;h=k.pos;d.d=setTimeout(a,0);d.position=h;return}f[i[2]|0]=r}e.postMessage(c[h++].webMidiLink,"*")}while(h<l&&c[h].time===b);h<l?(m=Date.now()-m,d.d=setTimeout(a,d.f/(1E3*g)*(c[h].time-b-m)*(1/d.F))):d.p&&f[0]&&"number"===typeof f[0].pos?(h=f[0].pos,d.d=setTimeout(a,0)):d.r&&(b=d,b.f=5E5,b.position=0,Q(d));d.position=h}}var d=b,g=b.B.T,c=b.g,e=b.b.contentWindow,h=b.position||0,f=[];b.pause?(b.d=setTimeout(a,b.e),b.pause=
s,b.e=-1):b.d=setTimeout(a,b.f/1E3*g*b.g[0].time)}
